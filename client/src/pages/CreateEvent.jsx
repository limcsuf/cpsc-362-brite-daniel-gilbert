...
export default function CreateEvent() {
    ...
    const { user } = useAuth();
    const [formData, setFormData] = useState({ title: '', date: '', address: '' });
    ...
    return (
        <div className="max-w-xl mx-auto mt-10">
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
                ...
                <h2 className="text-2xl font-bold text-center mb-6 text-gray-800 dark:text-gray-200">Create New Event</h2>
