  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        ...
        // If the event's category isn't in the list (e.g., it's new), default to creation mode
        if (
          initialEvent?.category &&
          !categories.includes(initialEvent.category)
        ) {
    ...
    fetchCategories();
  }, [initialEvent]); // Depend on initialEvent
